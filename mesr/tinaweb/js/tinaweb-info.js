           ...
           var layout_name=tinaviz.get("layout/algorithm");
            ...
            for(var id in lastselection) {
                ...
                if (node.category == current_cat)  { 
                    ...
                    if (current_cat !== undefined) { 
                        ...
                        contentinnerdiv.append( $("<b></b>").html(label + ' ' + periods2date(period)));
            ...
            if ( yearsArray[0] != undefined){ // we have phylogenetic data
                ...
                for (i=0;i<num_labels;i=i+1){
                    ...
                    if (years.length==1){
                        labelinnerdiv.append($("<b></b>").html(currentLabel + " (" + period2date(years[0]) + ")"));
                    }else if(years.length==2){
                        labelinnerdiv.append( $("<b></b>").html(currentLabel + " (" + period2date(years[0])+ "," + period2date(years[1]) + ")"));
                    }else {
                        labelinnerdiv.append( $("<b></b>").html(currentLabel + " (" + period2date(years[0])+ ", ... " + period2date(years[years.length-1]) + ")"));
                    }
                }
