...
echo 'affichage du réseau social';
?>
...
<noscript>
  	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
			id="SitePoint_DataViz_Tutorial_Part3" width="70%" height="70%"
			...
			<embed src="SitePoint_DataViz_Tutorial_Part3.swf" quality="high" bgcolor="#869ca7"
				width="70%" height="70%" name="SitePoint_DataViz_Tutorial_Part3" align="middle"
				play="true"
				loop="false"
				quality="high"
				allowScriptAccess="sameDomain"
