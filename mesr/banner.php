...
echo '<table class=tableitems style="font-variant:small-caps;" width="100%">
	<tr>
	<td><a href=global.php'.$periodstr.'>cartes</a> - <a href=entree_clusters.php'.$periodstr.'>champs thématiques</a> - <a href=entree_sources.php'.$periodstr.'>sources</a> - <a href=entree_termes.php'.$periodstr.'>termes</a> </td><td style="text-align: right"><a href=commentaires.php>commentaires</a></td>
	</tr>
	</table>';
echo '</div>';
echo '</div>';
