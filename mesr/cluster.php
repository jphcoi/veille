...
if ($nav=="phylo"){
	...
	echo '</table>';
        ...
        $JSonFilThematique=id_partition2streamgraphData($id_partition,3,'',$partition_infos[first_period],$partition_infos[last_period],  getValue('dT'),  getValue('time_steps'));        
